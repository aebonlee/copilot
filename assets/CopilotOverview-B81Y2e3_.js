...
> 이 플랫폼은 Microsoft Copilot의 전체 생태계를 한곳에서 학습할 수 있도록 설계되었습니다.`,contentEn:`**Microsoft Copilot** is Microsoft's AI assistant brand, integrated across various products from development to business operations.
...
> This platform is designed to help you learn the entire Microsoft Copilot ecosystem in one place.`},{title:"GitHub Copilot 소개",titleEn:"Introduction to GitHub Copilot",content:`**GitHub Copilot**은 GitHub와 OpenAI가 공동 개발한 AI 기반 코딩 어시스턴트입니다.
...
> 학생과 오픈소스 기여자는 GitHub Copilot Pro를 **무료**로 이용할 수 있습니다.`,contentEn:`### GitHub Copilot Pricing Plans
...
> Students and open-source contributors can use GitHub Copilot Pro for **free**.`}]},S={id:"setup",icon:"fa-gear",title:"설치 & 설정",titleEn:"Installation & Setup",sections:[{title:"VS Code에서 설치하기",titleEn:"Install in VS Code",content:`### 1단계: Extension 설치
...
> After installation, suggestions appear as gray text when you type code. Press **Tab** to accept.`}]},c=[x,S];function A(){const{language:u}=h(),i=u==="ko",[n,a]=b.useState(0),l=c[n],d={code({inline:o,className:e,children:s,...C}){const r=/language-(\w+)/.exec(e||"");return!o&&r?t.jsx(p,{code:String(s).replace(/\n$/,""),language:r[1]}):!o&&!r&&String(s).includes(`
`)?t.jsx(p,{code:String(s).replace(/\n$/,""),language:""}):t.jsx("code",{className:"inline-code",...C,children:s})},table({children:o}){return t.jsx("div",{className:"table-responsive",children:t.jsx("table",{children:o})})},blockquote({children:o}){return t.jsx(v,{type:"tip",children:o})},a({href:o,children:e,...s}){return o&&o.startsWith("/")?t.jsx("a",{href:o,...s,children:e}):t.jsx("a",{href:o,target:"_blank",rel:"noopener noreferrer",...s,children:e})}};return t.jsxs("div",{className:"guide-page",children:[t.jsx(f,{title:i?"Copilot 개요":"Copilot Overview",path:"/copilot-overview"}),t.jsxs("div",{className:"guide-layout",children:[t.jsxs("aside",{className:"guide-sidebar",children:[t.jsx("div",{className:"guide-sidebar-title",children:i?"목차":"Contents"}),t.jsx("ul",{className:"guide-nav",children:c.map((o,e)=>t.jsx("li",{className:"guide-nav-item",children:t.jsxs("button",{className:`guide-nav-link ${e===n?"active":""}`,onClick:()=>a(e),children:[t.jsx("i",{className:`fa-solid ${o.icon} nav-icon`})," ",i?o.title:o.titleEn]})},o.id))})]}),t.jsxs("div",{className:"guide-content",children:[t.jsx("div",{className:"guide-content-header",children:t.jsx("h1",{children:i?l.title:l.titleEn})}),l.sections.map((o,e)=>t.jsxs("div",{className:"guide-section",children:[t.jsx("h2",{children:i?o.title:o.titleEn}),t.jsx("div",{className:"markdown-body",children:t.jsx(m,{remarkPlugins:[g],components:d,children:i?o.content:o.contentEn})})]},e)),t.jsxs("div",{className:"guide-section-nav",children:[t.jsxs("button",{disabled:n===0,onClick:()=>a(n-1),children:[t.jsx("i",{className:"fa-solid fa-chevron-left"})," ",i?"이전":"Previous"]}),t.jsxs("button",{disabled:n===c.length-1,onClick:()=>a(n+1),children:[i?"다음":"Next"," ",t.jsx("i",{className:"fa-solid fa-chevron-right"})]})]})]})]})]})}export{A as default};
