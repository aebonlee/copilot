import{j as e}from"./markdown-CFpoqxyr.js";import{u as n}from"./index-CJbTAksm.js";import{G as r}from"./GuidePage-CW7JUf02.js";/* empty css                 */import{L as o}from"./vendor-D7XqJCDT.js";import"./supabase-k82gbVKr.js";import"./pdf-ckwbz45p.js";import"./SEOHead-Sm0tfk7_.js";const a={id:"prompt-basics",icon:"fa-lightbulb",title:"프롬프트 기초",titleEn:"Prompt Fundamentals",sections:[{title:"프롬프트란 무엇인가",titleEn:"What is a Prompt",content:`AI 모델에게 원하는 결과를 얻기 위해 전달하는 입력 텍스트를 **프롬프트(Prompt)**라고 합니다.
...
> Practice grows faster with colleagues than alone. Actively use team exercises.`}]};function y(){const{language:i}=n(),t=i==="ko";return e.jsx(e.Fragment,{children:e.jsx(r,{seoTitle:"프롬프트 실습",seoTitleEn:"Prompt Lab",seoDescription:"프롬프트 작성 기법, 평가 기준, 실전 예시 및 실습 가이드",path:"/prompt-eval",dataFiles:[a,s,c,l],ctaBanner:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"prompt-practice-cta",children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"프롬프트 작성 평가":"Prompt Writing Evaluation"}),e.jsx("p",{children:t?"프롬프트를 직접 작성하고 SCORE 기준으로 자동 채점! 수정하며 점수 변화를 확인하세요.":"Write prompts and get auto-scored! Edit and track your score improvements."})]}),e.jsxs(o,{to:"/prompt-eval/workshop",className:"prompt-practice-cta-btn",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),t?"작성 평가 시작":"Start Workshop"]})]}),e.jsxs("div",{className:"prompt-practice-cta",style:{background:"linear-gradient(135deg, rgba(56,161,105,0.08), rgba(56,161,105,0.02))",borderColor:"rgba(56,161,105,0.2)"},children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"종합 실습 테스트":"Full Practice Test"}),e.jsx("p",{children:t?"선택형 퀴즈 + 프롬프트 평가 + 직접 작성까지, 250점 만점 종합 실습을 진행하세요.":"Take a 250-point practice: quiz + evaluation + writing exercises."})]}),e.jsxs(o,{to:"/prompt-eval/practice",className:"prompt-practice-cta-btn",style:{background:"#38a169"},children:[e.jsx("i",{className:"fa-solid fa-clipboard-check"}),t?"종합 실습 시작":"Start Practice"]})]})]})})})}export{y as default};
