        ...
        <div className="footer-content">
          <div className="footer-brand">
            <div className="footer-logo">
              <span className="brand-claude">Copilot</span>
          ...
          <div className="footer-links">
            ...
            <ul className="footer-link-list">
              ...
              <li><Link to="/copilot-overview">{language === 'ko' ? 'Copilot 개요' : 'Overview'}</Link></li>
              <li><Link to="/copilot-vscode">VS Code</Link></li>
              <li><Link to="/copilot-chat">Copilot Chat</Link></li>
              <li><Link to="/copilot-cli">CLI</Link></li>
              <li><Link to="/copilot-extensions">Extensions</Link></li>
              <li><Link to="/copilot-enterprise">Enterprise</Link></li>
