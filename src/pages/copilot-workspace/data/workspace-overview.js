export default {
  ...
  icon: 'fa-laptop-code',
  title: 'Workspace 개요',
  titleEn: 'Workspace Overview',
  sections: [
    {
      title: 'Copilot Workspace란?',
      titleEn: 'What is Copilot Workspace?',
      content: `### GitHub Copilot Workspace
...
> Copilot Workspace는 아이디어에서 코드까지의 거리를 획기적으로 줄여줍니다.`,
      contentEn: `### GitHub Copilot Workspace
...
> Copilot Workspace dramatically reduces the distance from idea to code.`,
    },
  ],
};
