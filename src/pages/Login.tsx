    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <div className="auth-social">
          ...
          <button type="button" className="btn btn-social btn-kakao" onClick={handleKakaoLogin}>
        ...
        <form className="auth-form" onSubmit={handleEmailLogin}>
          ...
          <div className="auth-field">
            ...
            <input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder={t('auth.email')} required autoComplete="email" />
          </div>
          <div className="auth-field">
            <label htmlFor="password">{t('auth.password')}</label>
            <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder={t('auth.password')} required autoComplete="current-password" />
          </div>
