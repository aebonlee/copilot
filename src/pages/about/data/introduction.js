export default {
  ...
  titleEn: 'About Copilot Master',
  sections: [
    {
      title: '플랫폼 소개',
      titleEn: 'Platform Overview',
      content: `**Copilot Master**는 Microsoft Copilot 생태계의 모든 기능을 체계적으로 학습할 수 있는 종합 플랫폼입니다.
...
| **업무자동화 실전** | 문서·이메일·데이터·워크플로우 자동화 시나리오 |`,
      contentEn: `**Copilot Master** is a comprehensive platform for systematically learning the entire Microsoft Copilot ecosystem.
...
| **Work Automation** | Document, email, data, and workflow automation scenarios |`,
    },
  ],
};
