export default {
  ...
  sections: [
    {
      title: 'Copilot Chat 시작하기',
      titleEn: 'Getting Started with Copilot Chat',
      content: `### Copilot Chat이란?
...
> Copilot Chat은 열려 있는 파일과 프로젝트 구조를 자동으로 이해합니다.`,
      contentEn: `### What is Copilot Chat?
...
> Copilot Chat automatically understands open files and project structure.`,
    },
  ],
};
